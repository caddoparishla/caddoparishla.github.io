...
function getFormHTML(paneName)
{
	...
	/* WvanWeelden consultancy Begin keyword filter */
	sForm += "</tr>";
	sForm += "<tr class=\"hilite\">";
	sForm += '<td width="20%">\
				<select name="keywordModule" id="keywordModule" class="module" onchange="sendValueMessage(this)">\
